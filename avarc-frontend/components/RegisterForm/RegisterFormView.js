            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="space-y-6">
                    <h2 className="text-2xl font-bold text-center">
                        {safeTranslate('register.title', 'auth')}
                    </h2>
                    ...
                    {error && (
                        <div className="rounded-md bg-red-50 p-4">
                            <div className="text-sm text-red-700">{safeTranslate(`api.${error}`, 'api')}</div>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <input
                                type="text"
                                name="username"
                                placeholder={safeTranslate('register.usernamePlaceholder', 'auth')}
                        ...
                        <div>
                            <input
                                type="password"
                                name="password"
                                placeholder={safeTranslate('register.passwordPlaceholder', 'auth')}
                        ...
                        <div>
                            <input
                                ...
                                placeholder={safeTranslate('register.confirmPasswordPlaceholder', 'auth')}
                        ...
                        >
                            {loading ? safeTranslate('register.creatingAccount', 'auth') : safeTranslate('register.createAccount', 'auth')}
                        </Button>
                    </form>

                    <div className="text-sm text-center">
                        <Link href="/auth/login" className="font-medium text-gray-600 hover:text-gray-900">
                            {safeTranslate('register.haveAccount', 'auth')}
                        </Link>
                    </div>
                </div>
            </div>
